function [ F1, F2, F3, F4, M1, M2, M3, M4 ] = par_robsFins( ui_in, x, rho, ARe, dCL, CDc, Cd0, ec, Sfin )
...
%}
stall_angle    =   30.000000*180/pi; % arcdeg
...
if (norm_v4 < 0.001)
    ...
    alpha4 = elev_ang + v2(3)/v2(1); % atan2(v4(3),v4(1)) + elev_ang;
end
